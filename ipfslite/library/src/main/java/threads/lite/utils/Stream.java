...
public class Stream {
    ...
    public static Adder getFileAdder(@NonNull BlockStore blockStore) {
        Exchange exchange = new OfflineExchange(blockStore);
    ...
    public static Cid createEmptyDir(@NonNull BlockStore storage) {
    ...
    public static Cid addLinkToDir(@NonNull BlockStore storage, @NonNull Closeable closeable,
                                   @NonNull Cid dir, @NonNull String name, @NonNull Cid link) throws ClosedException {

        Adder fileAdder = getFileAdder(storage);

        Exchange exchange = new OfflineExchange(storage);
        BlockService blockservice = BlockService.createBlockService(storage, exchange);
        DagService dagService = DagService.createDagService(blockservice);
    ...
    public static Cid removeLinkFromDir(@NonNull BlockStore storage, @NonNull Closeable closeable,
    ...
    @NonNull
    public static Cid write(@NonNull BlockStore storage, @NonNull WriterStream writerStream) {
