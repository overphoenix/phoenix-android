...
public class RelayService {
    ...
    public static RelayConnection createRelayConnection(
            ...
            int timeout, int maxIdleTimeoutInSeconds, int initialMaxStreams, int initialMaxStreamData,
        ...
        PeerId relayId = PeerId.fromBase58(
                multiaddr.getStringComponent(Protocol.Type.IPFS));
        ...
        QuicConnection conn = liteHost.getConnection(relayId);
        if (conn == null) {
            conn = Dialer.dial(liteHost, relayId, relayAddr, timeout,
