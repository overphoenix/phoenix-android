...
public class NonReachableCache {
    ...
    private final static long PURGE_TIME_MULTIPLIER = TimeUnit.MINUTES.toMillis(5);
    // v6 addresses are unlikely to suffer from dynamic IP reuse, it should be safe to cache them longer
    private final static long PURGE_TIME_MULTIPLIER_V6 = TimeUnit.MINUTES.toMillis(15);
