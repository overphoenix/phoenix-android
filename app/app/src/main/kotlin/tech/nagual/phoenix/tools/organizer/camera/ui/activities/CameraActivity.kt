...
import tech.nagual.phoenix.tools.organizer.camera.BlurBitmap
import tech.nagual.phoenix.tools.organizer.camera.CamConfig
import tech.nagual.phoenix.tools.organizer.camera.CustomLocationListener
...
import tech.nagual.phoenix.tools.organizer.camera.notifier.SensorOrientationChangeNotifier
import tech.nagual.phoenix.tools.organizer.camera.ui.BottomTabLayout
import tech.nagual.phoenix.tools.organizer.camera.ui.CountDownTimerUI
import tech.nagual.phoenix.tools.organizer.camera.ui.CustomGrid
import tech.nagual.phoenix.tools.organizer.camera.ui.SettingsDialog
import tech.nagual.phoenix.tools.organizer.camera.ui.seekbar.ExposureBar
import tech.nagual.phoenix.tools.organizer.camera.ui.seekbar.ZoomBar
import java.io.File
...
open class CameraActivity : AppCompatActivity(),
    ...
    private val runnable = Runnable {
        ...
        val autoFocusPoint = factory.createPoint(
            ...
            previewView.height / 2.0f, 0.0f//qrOverlay.size
        )
    ...
    val requiresVideoModeOnly: Boolean
        get() {
            return this is VideoCaptureActivity
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.organizer_camera_activity)
...
//                }
        ...
        previewView.previewStreamState.observe(this) { state: StreamState ->
            if (state == StreamState.STREAMING) {
                ...
                if (lastFrame != null && this !is CaptureActivity && this !is MultiCaptureActivity) {
...
//                fTHandler.postDelayed(fTRunnable, focusTimeout * 1000)
    ...
    override fun onOrientationChange(orientation: Int) {
        ...
        CameraActivity.camConfig.imageCapture?.targetRotation = tr
        CameraActivity.camConfig.videoCapture?.targetRotation = tr
        CameraActivity.camConfig.iAnalyzer?.targetRotation = tr
