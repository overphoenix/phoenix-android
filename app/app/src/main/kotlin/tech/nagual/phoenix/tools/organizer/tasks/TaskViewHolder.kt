...
import tech.nagual.phoenix.tools.organizer.utils.applyMask
...
class TaskViewHolder(
    ...
    private val binding: OrganizerTaskItemBinding,
    ...
    init {
        with(binding) {
            val verticalPadding = if (inPreview) 4.dp() else 8.dp()
    ...
    private val colorMaskDrag =
        context.resolveAttribute(R.attr.colorHighlightMask) ?: Color.TRANSPARENT
