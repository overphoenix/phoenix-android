...
import tech.nagual.phoenix.tools.camera.clearExif
import tech.nagual.phoenix.tools.camera.fixExif
...
class ImageCapturer(private val mActivity: CameraActivity) {
    ...
    fun takePicture() {
        ...
        if (camConfig.requireLocation) {
            ...
            val location = CameraManager.getInstance().getLocation()
            if (location == null) {
                mActivity.showMessage(
