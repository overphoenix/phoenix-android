...
class CountDownTimerUI @JvmOverloads constructor(
    ...
    lateinit var mActivity: CameraActivity
    ...
    fun setMainActivity(cameraActivity: CameraActivity) {
    ...
    fun startTimer() {
        ...
        timer = object : CountDownTimer(mActivity.timerDuration * 1000L, 1000L) {
            ...
            override fun onFinish() {
                ...
                } else if (mActivity is MultiCaptureActivity) {
                    (mActivity as MultiCaptureActivity).takePicture()
                } else {
    ...
    private fun onTimerEnd(isCancelled: Boolean = false) {
        ...
        if (mActivity !is CaptureActivity && mActivity !is MultiCaptureActivity) {
