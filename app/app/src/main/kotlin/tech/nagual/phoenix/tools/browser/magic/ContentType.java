...
public enum ContentType {
     ...
     * Bittorrent file
     */
    BITTORRENT("application/x-bittorrent", "bittorrent", "threads/bt"),
    /**
     ...
     * Real-media file
     */
    REAL_MEDIA("application/vnd.rn-realmedia", "real-media", "pinRm"),
    /**
     * RFC822 news message
     */
    ...
    private final static Map<String, ContentType> fileExtensionMap = new HashMap<>();
