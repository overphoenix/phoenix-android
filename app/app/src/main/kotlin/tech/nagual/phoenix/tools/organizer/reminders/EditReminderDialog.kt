...
import tech.nagual.phoenix.databinding.OrganizerDialogEditReminderBinding
...
@AndroidEntryPoint
class EditReminderDialog : BaseDialog<OrganizerDialogEditReminderBinding>() {
    ...
    override fun createBinding(inflater: LayoutInflater) = OrganizerDialogEditReminderBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        when {
            this::reminder.isInitialized -> {
                ...
                dialog.setButton(AlertDialog.BUTTON_NEUTRAL, getString(R.string.delete_action)) { _, _ ->
                ...
                dialog.setTitle(getString(R.string.new_reminder))
                binding.editTextReminderName.requestFocusAndKeyboard()
    ...
    private fun setupListeners(
        dialog: AlertDialog,
        binding: OrganizerDialogEditReminderBinding,
        reminder: Reminder,
    ) {
