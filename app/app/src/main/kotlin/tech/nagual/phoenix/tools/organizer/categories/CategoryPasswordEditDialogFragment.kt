...
import tech.nagual.phoenix.databinding.OrganizerCategoryPasswordEditDialogBinding
...
@AndroidEntryPoint
class CategoryPasswordEditDialogFragment : CategoryBaseEditDialogFragment() {
    private lateinit var binding: OrganizerCategoryPasswordEditDialogBinding

    override fun createView(savedInstanceState: Bundle?): View {
        binding =
            OrganizerCategoryPasswordEditDialogBinding.inflate(requireContext().layoutInflater)
    ...
    companion object {
        fun show(
            ...
            CategoryPasswordEditDialogFragment().putArgs(Args(category, categoryType, workflowId))
                .show(fragment)
        }
    }
}
