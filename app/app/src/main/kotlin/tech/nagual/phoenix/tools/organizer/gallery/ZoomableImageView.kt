...
class ZoomableImageView @JvmOverloads constructor(
    ...
    lateinit var gActivity: GalleryActivity
    ...
    private val currentInstance: ZoomableImageView
        get() {
            return gActivity.gallerySlider.getChildAt(0)
                .findViewById(R.id.organizer_slide_preview)
        }

    fun setGalleryActivity(gActivity: GalleryActivity) {
    ...
    private inner class ScaleListener : SimpleOnScaleGestureListener() {
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            if (origWidth * saveScale <= viewWidth || origHeight * saveScale <= viewHeight
                ...
                mScaleFactor, mScaleFactor, viewWidth / 2f, viewHeight / 2f
