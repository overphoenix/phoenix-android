...
class CategoriesAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        binding.checkBox.isChecked = rawCategory.isActive()
        binding.checkBox.setOnClickListener {
            var flags = rawCategory.flags
            if (binding.checkBox.isChecked)
                flags = flags or RawCategory.FLAG_ACTIVE
            else
                flags = flags and RawCategory.FLAG_ACTIVE.inv()
            listener.updateCategoryFlags(rawCategory.id, flags)
        }
...
//        }
    ...
    interface Listener {
        ...
        fun updateCategoryFlags(categoryId: Long, flags: Long)
