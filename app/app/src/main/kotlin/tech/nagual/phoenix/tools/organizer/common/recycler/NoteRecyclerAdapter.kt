...
class NoteRecyclerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoteViewHolder {
        val binding = OrganizerNoteItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private class DiffCallback : DiffUtil.ItemCallback<Note>() {
        ...
        override fun getChangePayload(oldItem: Note, newItem: Note): Any {
            return sequenceOf(
                ...
                Payload.CategoriesChanged to (oldItem.variants != newItem.variants)
            )
