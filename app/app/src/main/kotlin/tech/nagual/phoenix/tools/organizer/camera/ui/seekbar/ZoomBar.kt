package tech.nagual.phoenix.tools.organizer.camera.ui.seekbar
...
class ZoomBar : AppCompatSeekBar {
    ...
    private var thumbView: View = LayoutInflater.from(context)
        .inflate(R.layout.organizer_camera_zoom_bar_thumb, null, false)
    ...
    private fun togglePanel(visibility: Int) {
        ...
        TransitionManager.beginDelayedTransition(
            cameraActivity.window.decorView.rootView as ViewGroup, transition
        )
        cameraActivity.zoomBarPanel.visibility = visibility
    }
