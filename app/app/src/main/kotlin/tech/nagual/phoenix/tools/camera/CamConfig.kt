...
import tech.nagual.phoenix.tools.camera.analyzer.QRAnalyzer
import tech.nagual.phoenix.tools.camera.capturer.VideoCapturer.Companion.isVideo
import tech.nagual.phoenix.tools.camera.ui.activities.*
...
class CamConfig(private val mActivity: CameraActivity) {
    ...
    private object CameraModes {
        ...
        const val QR_SCAN = R.string.camera_qr_scan_mode
    }
...
//                Toast.LENGTH_LONG).show()
    ...
    fun switchMode(modeText: Int) {
        ...
        if (isQRMode) {
            ...
            mActivity.captureButton.setImageResource(R.drawable.camera_torch_off_button)
    ...
    fun showMoreOptionsForQR() {
        ...
        builder.setTitle(mActivity.resources.getString(R.string.camera_more_options))
