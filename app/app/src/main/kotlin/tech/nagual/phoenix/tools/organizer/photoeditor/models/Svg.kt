...
import tech.nagual.phoenix.tools.organizer.photoeditor.PainterCanvas
import tech.nagual.phoenix.tools.organizer.photoeditor.PhotoEditorActivity
...
object Svg {
    ...
    fun loadSvg(activity: PhotoEditorActivity, fileOrUri: Any, canvas: PainterCanvas) {
    ...
    private fun parseSvg(activity: PhotoEditorActivity, fileOrUri: Any): SSvg {
