...
import tech.nagual.phoenix.tools.organizer.camera.clearExif
import tech.nagual.phoenix.tools.organizer.camera.fixExif
...
//                    mActivity.previewLoader.visibility = View.GONE
    ...
    companion object {
        ...
        fun isImage(uri: Uri): Boolean {
            return uri.encodedPath?.contains("image") == true ||
                    uri.encodedPath?.contains("img") == true ||
                    uri.encodedPath?.endsWith(".jpg") == true ||
