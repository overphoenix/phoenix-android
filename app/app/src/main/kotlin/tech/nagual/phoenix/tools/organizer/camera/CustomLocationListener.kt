...
class CustomLocationListener(private val mActivity: CameraActivity) : LocationListener {
    ...
    fun start() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                val builder = MaterialAlertDialogBuilder(mActivity, android.R.style.Theme_DeviceDefault_Dialog_Alert)
                builder.setTitle(R.string.camera_location_permission_dialog_title)
                builder.setMessage(R.string.camera_location_permission_dialog_message)
