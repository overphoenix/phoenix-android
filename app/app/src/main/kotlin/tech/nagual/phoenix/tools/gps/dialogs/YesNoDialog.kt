...
class YesNoDialog(private var yesNoDialogListener: YesNoDialogListener) {
    ...
    fun show(
        ...
        message: Int,
        yesButton: Int = R.string.trackbook_dialog_yes_no_positive_button_default,
        noButton: Int = R.string.trackbook_dialog_generic_button_cancel,
    ...
    fun show(
        ...
        val builder: MaterialAlertDialogBuilder =
            MaterialAlertDialogBuilder(context, R.style.TrackbookAlertDialogTheme)
