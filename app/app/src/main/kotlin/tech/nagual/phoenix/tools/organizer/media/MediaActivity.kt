...
import tech.nagual.phoenix.databinding.OrganizerActivityMediaBinding
import tech.nagual.phoenix.tools.organizer.attachments.getAlbumArtBitmap
...
class MediaActivity : BaseActivity() {
    private lateinit var binding: OrganizerActivityMediaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = OrganizerActivityMediaBinding.inflate(layoutInflater)
        ...
        when (attachment.type) {
            ...
            Attachment.Type.PHOTO -> handleImageAttachment()
    ...
    override fun onResume() {
        ...
        if (attachment.type == Attachment.Type.VIDEO && (exoPlayer == null)) {
            handleVideoAttachment()
        }
    }
