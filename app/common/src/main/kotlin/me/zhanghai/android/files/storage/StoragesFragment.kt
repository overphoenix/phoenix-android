...
import tech.nagual.common.databinding.StoragesFragmentBinding
import tech.nagual.settings.Settings
import me.zhanghai.android.files.util.*
import me.zhanghai.android.files.util.fadeToVisibilityUnsafe
import me.zhanghai.android.files.util.putArgs

class StoragesFragment : Fragment(), StoragesAdapter.Listener {
    private lateinit var binding: StoragesFragmentBinding
    ...
    override fun onCreateView(
        ...
        StoragesFragmentBinding.inflate(inflater, container, false)
            .also { binding = it }
            .root
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.speedDialView.inflate(R.menu.storage_list_speed_dial)
        binding.speedDialView.setOnActionSelectedListener {
            when (it.id) {
                R.id.action_add_document_tree -> onAddDocumentTree()
                R.id.action_add_sftp_server -> onAddSftpServer()
                R.id.action_add_smb_server -> onAddSmbServer()
            }
    ...
    private fun onAddDocumentTree() {
        startActivitySafe(AddDocumentTreeActivity::class.createIntent())
    }

    private fun onAddSftpServer() {
        startActivitySafe(EditSftpServerActivity::class.createIntent()
            .putArgs(EditSftpServerFragment.Args()))
    }

    private fun onAddSmbServer() {
