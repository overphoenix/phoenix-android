...
import tech.nagual.common.databinding.NavigationFragmentBinding
...
import me.zhanghai.android.files.bookmarks.EditBookmarkDirectoryDialogActivity
import me.zhanghai.android.files.bookmarks.EditBookmarkDirectoryDialogFragment
...
class NavigationFragment : Fragment(), NavigationItem.Listener {
    ...
    override fun onEditTool(tool: Tool) {
