...
import tech.nagual.common.ui.*
import tech.nagual.common.ui.speeddial.SpeedDialView
import me.zhanghai.android.files.util.*
import tech.nagual.common.databinding.*
import me.zhanghai.android.files.features.texteditor.TextEditorActivity
...
import me.zhanghai.android.files.bookmarks.BookmarkDirectories
...
class FileListFragment : Fragment(), BreadcrumbLayout.Listener, FileListAdapter.Listener,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.speedDialView.inflate(R.menu.files_speed_dial)
    ...
    private fun updateOverlayToolbar() {
        ...
        val pickOptions = viewModel.pickOptions
        if (pickOptions != null) {
            overlayActionMode.title = getString(R.string.list_select_title_format, files.size)
            overlayActionMode.setMenuResource(R.menu.files_pick)
            val menu = overlayActionMode.menu
            menu.findItem(R.id.action_select_all).isVisible = pickOptions.allowMultiple
        } else {
            overlayActionMode.title = getString(R.string.list_select_title_format, files.size)
            overlayActionMode.setMenuResource(R.menu.files_select)
            val menu = overlayActionMode.menu
    ...
    private fun updateBottomToolbar() {
        ...
        if (pickOptions != null) {
            ...
            bottomActionMode.setMenuResource(R.menu.files_paste)
            val isCurrentPathReadOnly = viewModel.currentPath.fileSystem.isReadOnly
    ...
    override fun showPropertiesDialog(file: FileItem) {
        me.zhanghai.android.files.fileproperties.FilePropertiesDialogFragment.show(file, this)
    }
    ...
    companion object {
        private const val ACTION_VIEW_DOWNLOADS =
            "tech.nagual.phoenix.intent.action.VIEW_DOWNLOADS"
