...
class FingerprintTab(context: Context, attrs: AttributeSet) : RelativeLayout(context, attrs),
    ...
    private lateinit var fingerprintSettings: MyTextView
    private lateinit var fingerprintLabel: MyTextView

    override fun onFinishInflate() {
        super.onFinishInflate()

        fingerprintSettings = findViewById(R.id.fingerprint_settings)
