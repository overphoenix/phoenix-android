...
val notificationManager: NotificationManager by lazy {
    application.getSystemServiceCompat(NotificationManager::class.java)
}
...
val locationManager: LocationManager by lazy {
    application.getSystemServiceCompat(LocationManager::class.java)
}

val sensorManager: SensorManager by lazy {
    application.getSystemServiceCompat(SensorManager::class.java)
}

val alarmManager: AlarmManager by lazy {
    application.getSystemServiceCompat(AlarmManager::class.java)
}