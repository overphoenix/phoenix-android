...
import tech.nagual.common.preferences.helpers.DEFAULT_RES_ID
import tech.nagual.common.preferences.helpers.DependencyManager
import tech.nagual.common.preferences.helpers.KEY_ROOT_SCREEN
import tech.nagual.common.preferences.helpers.PreferenceMarker
import tech.nagual.common.preferences.preferences.CollapsePreference
import tech.nagual.common.preferences.preferences.SeekBarPreference
 ...
 * if [switch][tech.nagual.common.preferences.preferences.SwitchPreference],
 * [category header][tech.nagual.common.preferences.preferences.CategoryHeader] or
...
open class Preference(key: String) : AbstractPreference(key) {
    ...
    object Config {
        ...
        /**
         * Factory for [MaterialAlertDialogBuilder] that can be overridden for styling reasons.
         *
         ...
         */
        var dialogBuilderFactory: (Context) -> MaterialAlertDialogBuilder = { context ->
...
class PreferenceScreen private constructor(builder: Builder) : Preference(builder.key) {
    ...
    @PreferenceMarker
    class Builder private constructor(private var context: Context?, key: String) :
         ...
         * use the dsl helper methods like [pref][tech.nagual.common.preferences.helpers.pref],
         * [switch][tech.nagual.common.preferences.helpers.switch] and
         * [subScreen][tech.nagual.common.preferences.helpers.subScreen] for this.
         */
