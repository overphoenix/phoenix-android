        ...
        return NestedScrollView(requireContext()).apply {
            addView(
                LinearLayout(context).apply {
                    context.resolveAttribute(R.attr.colorSurface)
                        ?.let { background = ColorDrawable(it) }
                                ...
                                AppCompatTextView(
                                    ...
                                    text = when {
                                        header.isNullOrBlank() && showPlaceHolderText == true -> context.getString(
                                            R.string.bottom_sheet_untitled
                                        )
                                        else -> header
                                    }
                                }
