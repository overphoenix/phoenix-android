package tech.nagual.common.asynctasks
...
import tech.nagual.common.extensions.getMimeType
import tech.nagual.common.extensions.isMediaFile
...
import tech.nagual.common.helpers.getConflictResolution
...
class CopyMoveTask(
    val activity: tech.nagual.common.activities.BaseSimpleActivity, val copyOnly: Boolean, val copyMediaOnly: Boolean, val conflictResolutions: LinkedHashMap<String, Int>,
