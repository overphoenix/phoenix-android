package tech.nagual.common.views.bottomactionmenu
...
class BottomActionMenuPopup(private val activity: tech.nagual.common.activities.BaseSimpleActivity, items: List<BottomActionMenuItem>) {
    ...
    constructor(activity: tech.nagual.common.activities.BaseSimpleActivity, @MenuRes menuResId: Int) : this(activity, BottomActionMenuParser(activity).inflate(menuResId))
