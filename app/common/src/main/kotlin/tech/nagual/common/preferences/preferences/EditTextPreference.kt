...
open class EditTextPreference(key: String) : DialogPreference(key) {
    ...
    var valueReader: () -> Unit = {
        currentInput = getString()
    }

    override fun onAttach() {
        super.onAttach()
        if (currentInput == null) valueReader()
    }

    override fun createDialog(context: Context): Dialog =
        Config.dialogBuilderFactory(context).apply {
