package tech.nagual.common.preferences.views
...
class ModernSeekBar(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
        ...
        set(value) {
            ...
            if (value != null) {
                if (defaultMarkerDrawable == null) {
                    defaultMarkerDrawable =
                        ContextCompat.getDrawable(context, R.drawable.map_seekbar_default_marker)
                }
