...
import static tech.nagual.common.ui.speeddial.SpeedDialActionItem.RESOURCE_NOT_SET;
import static tech.nagual.common.ui.speeddial.SpeedDialView.ExpansionMode.BOTTOM;
import static tech.nagual.common.ui.speeddial.SpeedDialView.ExpansionMode.LEFT;
import static tech.nagual.common.ui.speeddial.SpeedDialView.ExpansionMode.RIGHT;
import static tech.nagual.common.ui.speeddial.SpeedDialView.ExpansionMode.TOP;
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            @DrawableRes int openDrawableRes = styledAttrs.getResourceId(R.styleable.SpeedDialView_sdMainFabClosedSrc,
                    SpeedDialActionItem.RESOURCE_NOT_SET);
            if (openDrawableRes != SpeedDialActionItem.RESOURCE_NOT_SET) {
            ...
            int closeDrawableRes = styledAttrs.getResourceId(R.styleable.SpeedDialView_sdMainFabOpenedSrc,
                    SpeedDialActionItem.RESOURCE_NOT_SET);
            if (closeDrawableRes != SpeedDialActionItem.RESOURCE_NOT_SET) {
            ...
            mOverlayLayoutId = styledAttrs.getResourceId(R.styleable.SpeedDialView_sdOverlayLayout, SpeedDialActionItem.RESOURCE_NOT_SET);
        } catch (Exception e) {
    ...
    private void visibilitySetup(boolean visible, boolean animate, boolean reverseAnimation) {
        ...
        if (visible) {
            for (int i = 0; i < size; i++) {
                ...
                // Commented for fixing this issue:
                // https://github.com/leinardi/FloatingActionButtonSpeedDial/issues/169
//                if (i == 0) {
