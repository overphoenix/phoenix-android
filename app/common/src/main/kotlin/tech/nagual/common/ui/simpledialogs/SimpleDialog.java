...
public class SimpleDialog<This extends SimpleDialog<This>> extends DialogFragment {
    ...
    private DialogInterface.OnClickListener forwardOnClickListener = (dialog, which) -> callResultListener(which, null);
    ...
    public This title(@StringRes int titleResourceId) {
        return setArg(TITLE, titleResourceId);
    }
    ...
    public This msg(@StringRes int messageResourceId) {
        return setArg(MESSAGE, messageResourceId);
    }
    ...
    public This pos(String positiveButton) {
        return setArg(POSITIVE_BUTTON_TEXT, positiveButton);
    }
    ...
    public This pos(@StringRes int positiveButtonResourceId) {
        return setArg(POSITIVE_BUTTON_TEXT, positiveButtonResourceId);
    }
    ...
    public This neg(String negativeButton) {
        return setArg(NEGATIVE_BUTTON_TEXT, negativeButton);
    }
    ...
    public This neg(@StringRes int negativeButtonResourceId) {
        return setArg(NEGATIVE_BUTTON_TEXT, negativeButtonResourceId);
    }
    ...
    public This neut(String neutralButton) {
        return setArg(NEUTRAL_BUTTON_TEXT, neutralButton);
    }
    ...
    public This neut(@StringRes int neutralButtonResourceId) {
        return setArg(NEUTRAL_BUTTON_TEXT, neutralButtonResourceId);
    }
    ...
    public This icon(@DrawableRes int iconResourceId) {
        return setArg(ICON_RESOURCE, iconResourceId);
    }
    ...
    public This cancelable(boolean cancelable) {
        return setArg(CANCELABLE, cancelable);
    }
    ...
    public This extra(Bundle extras) {
        getArgs().putBundle(BUNDLE, extras);
        return (This) this;
    }
