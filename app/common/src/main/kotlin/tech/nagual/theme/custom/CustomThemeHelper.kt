package tech.nagual.theme.custom
...
//                }
    ...
    private fun getCustomThemeRes(@StyleRes baseThemeRes: Int, context: Context): Int {
        ...
        val customThemeName = if (Settings.MATERIAL_DESIGN_3.valueCompat) {
            val defaultThemeName = resources.getResourceEntryName(R.style.Theme_Phoenix)
            val material3ThemeName =
                resources.getResourceEntryName(R.style.Theme_Phoenix_Material3)
